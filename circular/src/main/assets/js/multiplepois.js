...
var World = {
	...
	onMarkerSelected: function onMarkerSelectedFn(marker) {
		...
		document.location = "architectsdk://a?id="+marker.poiData.id;
	...
	detalhesParada: function detalhesParada(poiData){
        var singlePoi = {
                        "id": poiData.id,
