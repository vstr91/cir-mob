 ...
 */
public class Parametros extends PreferenceActivity {
    /**
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        CheckBoxPreference checkRA = (CheckBoxPreference) findPreference("tela_inicial_checkbox");

        SensorUtils sensorUtils = new SensorUtils();
        boolean temSensores = sensorUtils.checarSensores(this);

        if(!temSensores){
            checkRA.setEnabled(false);
        }
