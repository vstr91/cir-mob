...
public class BeyondarObject implements Plugable<BeyondarObjectPlugin> {
	...
	/**
	 * Get a {@link java.util.List} copy of the added plugins. Adding/removing plugins to
	 ...
	 * 
	 * This method is used by the {@link com.beyondar.android.opengl.renderer.ARRenderer} to set this value.
	 * 
	 * @param distance
	 *            Distance in meters.
	 */
