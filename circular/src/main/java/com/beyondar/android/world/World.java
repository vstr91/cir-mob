...
public class World implements Plugable<WorldPlugin> {
	...
	/**
	 * Add a {@link com.beyondar.android.plugin.WorldPlugin} to the {@link com.beyondar.android.world.World}. If the plugin exist it
	...
	/**
	 * Set user geo position using the {@link android.location.Location} object. The altitude is
	 ...
	 * in the {@link com.beyondar.android.world.World}
	 * 
	 ...
	 *            The {@link java.util.ArrayList} that will store the objects sorted by
